...
function Hero(props:{h1:string,p1:string,src:string,button:string,buttonClass:string}) {
  return (
    <div>
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <Image className="object-cover object-center rounded" alt="hero" src={props.src} width={720} height={600}/>
    </div>
  </div>
</section>
    </div>
