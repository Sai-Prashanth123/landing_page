...
export default function Home() {
  return (
    ...
    <section className="px-4 md:px-8 lg:mt-[14.5rem] mt-[10.5rem] ">
      ...
      <HeroImage />
      <div className="lg:w-[85.13rem] w-[25.8rem] right-9 lg:scale-125  h-[11.94rem] -z-30 lg:h-[500px] bg-gradient-to-br from-[#A4A9EA] via-[#4954D5] to-[#1B29CB] mt-20 lg:mt-52 relative overflow-hidden">
